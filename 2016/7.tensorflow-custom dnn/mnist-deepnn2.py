#understanding 3 layer deep neural network: all the layers are stacked(same as mnist-deepnn1.py)
#hidden layers: sigmoids
#ouput layer: softmax
#loss: cross entropy
#SGD with eta=0.5
...
def model_function(features, targets, mode):    
  ...
  hlayers = layers.stack(features, layers.fully_connected, [20,10], activation_fn = tf.sigmoid)
