...
#loss: cross entropy
#SGD with eta=0.5
#weights initialization: xaviour
...
def model_function(features, targets, mode):    
  ...
  hlayers = layers.stack(features, layers.fully_connected, [20,10], activation_fn = tf.nn.relu, weights_initializer=layers.xavier_initializer(True,seed=100))
