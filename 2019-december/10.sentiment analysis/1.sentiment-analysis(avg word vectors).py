...
data_dir = 'I:/word2vec-nlp-tutorial'
glove_file = 'I:/glove.6B.50d.txt'
word_embed_size = 50
batch_size = 64
epochs = 20
seq_maxlen = 80
...
review_train = imdb_train['review'][0:1000]
#preprocess text
review_train_clean = review_train.map(cleanReview)
...
y_train = np_utils.to_categorical(imdb_train['sentiment'][0:1000])
...
review_test = imdb_test['review'][0:100]

#preprocess text
review_test_clean = review_test.map(cleanReview)
