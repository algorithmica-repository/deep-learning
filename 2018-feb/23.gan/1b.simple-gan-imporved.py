...
def build_gan(latent_sample_size, descriminator_input_size, d_optimizer, g_optimizer):
...
generator, descriminator, gan = build_gan(latent_sample_size, descriminator_input_size, d_optimizer, g_optimizer)
