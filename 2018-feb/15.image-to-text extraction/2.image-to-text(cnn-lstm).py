...
from keras.layers import Dense, Dropout, Input, Conv2D, MaxPooling2D, Reshape, GRU, Bidirectional, TimeDistributed
...
#resize image features to feed into RNN
conv_to_rnn_dims = (label_length, int(inner.shape[1]*inner.shape[2]*inner.shape[3] // label_length))
